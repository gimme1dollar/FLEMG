...
class network_feedback_flex_feature_average:
    ...
    def train_network_prediction(self, training_data = [], training_label = [], iterations = 5000, batch_size = 2**14, training_data_changing_iter_size = 100, location = 'model/_', restore = False):
        if restore is False:
...
iteration = 2**4
batch_size = 2**10
training_data_changing_iter_size = 2
...
with Network.graph.as_default():
    ...
    loss=Network.train_network_prediction(training_data = trainData, training_label = trainLabel,iterations = iteration, batch_size = batch_size, training_data_changing_iter_size = training_data_changing_iter_size, location = model_dir, restore=False)

    print("Train Over\n")
    print("Model " + model_name + " saved\n")

    prediction, rmse_val = Network.infer_batch(testData, testLabel, batch_size)
