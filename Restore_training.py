...
#notebook_path_name = 'content/drive/folders/1x31x0v4WwAokwVd6ItkD6hn4J6YzcTFg'
...
target_dir = subject_dir + '/6_sequence'
...
with Network.graph.as_default():
    ...
    Network.restore(location=model_name+"/YHyu/20200202_1054")
