...
Network = Processor.network_feature_average()

Preprocessor.load(filename)
Preprocessor.scale()
feat_data=Preprocessor.feature_average()
trainIndex, trainData, trainLabel = Preprocessor.preprocess_feature_average(data=feat_data)
